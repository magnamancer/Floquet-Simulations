...
fig.suptitle(F"3LS with $\Omega_1$ polarization = {P2} THz {L2pol} polarization and swept detuning (detuning is from upper resonance)")
...
ax.set_title(F"3LS with $\Omega_1$ polarization = {P2} THz {L2pol} polarization and swept detuning (detuning is from upper resonance)")
fig.colorbar(pos, ax=ax)# # For plotting Excitation Arrays